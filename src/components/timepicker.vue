    ...
    <div class="relative flex justify-center">
        <div>
            ...
            <div class="relative flex justify-center">
                ...
                <div
                    v-if="isTime === true"
                    class=" bg-white  rounded p-2 absolute top-16 left-0 right-0"
                >
                    ...
                    <div class="flex  items-center gap-x-4 ">
                        ...
                        <div class="flex justify-center items-center flex-col gap-y-4">
                            ...
                            @click="incHr"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#8da8a4" height="24" width="24" version="1.1" id="Capa_1" viewBox="0 0 60.364 60.364" xml:space="preserve">
                                    <g>
                            ...
                            @click="decHr"
                            >
                            <svg fill="#8da8a4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="24" width="24" version="1.1" id="Capa_1" viewBox="0 0 52.161 52.161" xml:space="preserve">
                                <g>
